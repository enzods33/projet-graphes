...
from graphes.urquhart_graph import interactions_urquhart_graph as i_u
...
def ouvrir_canvas_urquhart_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_u.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_u.get_type_graphe)
