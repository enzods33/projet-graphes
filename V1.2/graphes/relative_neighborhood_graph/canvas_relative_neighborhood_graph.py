...
from graphes.relative_neighborhood_graph import interactions_relative_neighborhood_graph as i_rn
...
def ouvrir_canvas_relative_neighborhood_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_rn.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_rn.get_type_graphe)
