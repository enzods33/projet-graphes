...
from graphes.nearest_neighbor_graph import interactions_nearest_neighbor_graph as i_nn
...
def ouvrir_canvas_nearest_neighbor_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_nn.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_nn.get_type_graphe)
