...
from graphes.gabriel_graph import interactions_gabriel_graph as i_g
...
def ouvrir_canvas_gabriel_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_g.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_g.get_type_graphe)
