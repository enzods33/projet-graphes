...
from graphes.yao_graph import interactions_yao_graph as i_y
...
def ouvrir_canvas_yao_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_y.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_y.get_type_graphe)
