...
from graphes.theta_graph import interactions_theta_graph as i_t
...
def ouvrir_canvas_theta_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_t.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_t.get_type_graphe)
