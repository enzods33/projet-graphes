...
from graphes.k_closest_neighbors_graph import interactions_k_closest_neighbors_graph as i_kcn
...
def ouvrir_canvas_k_closest_neighbors_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_kcn.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_kcn.get_type_graphe)
