...
from graphes.yao4_linf_graph import interactions_yao4_linf_graph as i_yl
...
def ouvrir_canvas_yao4_linf_graph(root):
    ...
    ic.enregistrer_callback('is_connected', i_yl.is_connected)
    ic.enregistrer_callback('get_type_graphe', i_yl.get_type_graphe)
